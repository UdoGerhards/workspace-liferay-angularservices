...
The extension is still in **alpha state** and will be implemented currently with heavy changes to the source code and functionality too. Therefore **it is far away** to be used in working [Liferay](https://www.liferay.com/) installations since it is more a **POC at the moment**.
