...
/**
 * Provides the local service interface for AngularResourcePermission. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AngularResourcePermissionLocalServiceUtil
...
public interface AngularResourcePermissionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AngularResourcePermissionLocalServiceUtil} to access the Resource permission local service. Add custom service methods to {@link eu.gerhards.liferay.services.angular.service.impl.AngularResourcePermissionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AngularResourcePermission addAngularResourcePermission(
	...
	*/
	public AngularResourcePermission createAngularResourcePermission(
	...
	*/
	...
	public AngularResourcePermission deleteAngularResourcePermission(
		AngularResourcePermission angularResourcePermission);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AngularResourcePermission fetchAngularResourcePermission(
		long resourcePermissionId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AngularResourcePermission getAngularResourcePermission(
		long resourcePermissionId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AngularResourcePermission updateAngularResourcePermission(
		AngularResourcePermission angularResourcePermission);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AngularResourcePermission> getAngularResourcePermissions(
		int start, int end);
