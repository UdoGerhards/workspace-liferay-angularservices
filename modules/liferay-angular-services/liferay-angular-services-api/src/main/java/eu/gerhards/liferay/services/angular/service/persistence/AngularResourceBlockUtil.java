...
/**
 * The persistence utility for the Resource block service. This utility wraps {@link eu.gerhards.liferay.services.angular.service.persistence.impl.AngularResourceBlockPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 */
@ProviderType
public class AngularResourceBlockUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(AngularResourceBlock angularResourceBlock) {
		getPersistence().clearCache(angularResourceBlock);
	}
	 ...
	 */
	public static List<AngularResourceBlock> findWithDynamicQuery(
	 ...
	 */
	public static AngularResourceBlock update(
		AngularResourceBlock angularResourceBlock) {
		return getPersistence().update(angularResourceBlock);
	}
	 ...
	 */
	public static AngularResourceBlock update(
		AngularResourceBlock angularResourceBlock, ServiceContext serviceContext) {
		return getPersistence().update(angularResourceBlock, serviceContext);
	}
	...
	*/
	public static List<AngularResourceBlock> findByResourceBlockId(
	...
	*/
	public static AngularResourceBlock findByResourceBlockId_First(
		long resourceBlockId,
		OrderByComparator<AngularResourceBlock> orderByComparator)
		throws eu.gerhards.liferay.services.angular.exception.NoSuchAngularResourceBlockException {
		return getPersistence()
	...
	*/
	public static AngularResourceBlock fetchByResourceBlockId_First(
		long resourceBlockId,
		OrderByComparator<AngularResourceBlock> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchAngularResourceBlockException if a matching Resource block could not be found
	*/
	public static AngularResourceBlock findByResourceBlockId_Last(
		long resourceBlockId,
		OrderByComparator<AngularResourceBlock> orderByComparator)
		throws eu.gerhards.liferay.services.angular.exception.NoSuchAngularResourceBlockException {
		return getPersistence()
	...
	*/
	public static AngularResourceBlock fetchByResourceBlockId_Last(
		long resourceBlockId,
		OrderByComparator<AngularResourceBlock> orderByComparator) {
		return getPersistence()
	...
	*/
	public static void cacheResult(AngularResourceBlock angularResourceBlock) {
		getPersistence().cacheResult(angularResourceBlock);
	}
	...
	*/
	public static void cacheResult(
		List<AngularResourceBlock> angularResourceBlocks) {
		getPersistence().cacheResult(angularResourceBlocks);
	}
	...
	*/
	public static AngularResourceBlock create(long resourceBlockId) {
	...
	*/
	public static AngularResourceBlock remove(long resourceBlockId)
		throws eu.gerhards.liferay.services.angular.exception.NoSuchAngularResourceBlockException {
		return getPersistence().remove(resourceBlockId);
	}

	public static AngularResourceBlock updateImpl(
		AngularResourceBlock angularResourceBlock) {
		return getPersistence().updateImpl(angularResourceBlock);
	}
	...
	* @throws NoSuchAngularResourceBlockException if a Resource block with the primary key could not be found
	*/
	public static AngularResourceBlock findByPrimaryKey(long resourceBlockId)
		throws eu.gerhards.liferay.services.angular.exception.NoSuchAngularResourceBlockException {
	...
	*/
	public static AngularResourceBlock fetchByPrimaryKey(long resourceBlockId) {
		return getPersistence().fetchByPrimaryKey(resourceBlockId);
	}

	public static java.util.Map<java.io.Serializable, AngularResourceBlock> fetchByPrimaryKeys(
	...
	*/
	public static List<AngularResourceBlock> findAll() {
	...
	*/
	public static List<AngularResourceBlock> findAll(int start, int end) {
	...
	*/
	...
	public static AngularResourceBlockPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<AngularResourceBlockPersistence, AngularResourceBlockPersistence> _serviceTracker =
		ServiceTrackerFactory.open(AngularResourceBlockPersistence.class);
}