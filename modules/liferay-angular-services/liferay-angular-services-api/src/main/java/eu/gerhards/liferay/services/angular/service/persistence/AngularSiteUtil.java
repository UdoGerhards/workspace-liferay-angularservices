...
/**
 * The persistence utility for the Site service. This utility wraps {@link eu.gerhards.liferay.services.angular.service.persistence.impl.AngularSitePersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class AngularSiteUtil {
	 ...
	 */
	public static void clearCache(AngularSite angularSite) {
		getPersistence().clearCache(angularSite);
	}
	 ...
	 */
	public static List<AngularSite> findWithDynamicQuery(
	 ...
	 */
	public static AngularSite update(AngularSite angularSite) {
		return getPersistence().update(angularSite);
	}
	...
	public static AngularSite update(AngularSite angularSite,
		...
		return getPersistence().update(angularSite, serviceContext);
	}
	...
	*/
	public static void cacheResult(AngularSite angularSite) {
		getPersistence().cacheResult(angularSite);
	}
	...
	*/
	public static void cacheResult(List<AngularSite> angularSites) {
		getPersistence().cacheResult(angularSites);
	}
	...
	* @return the new Site
	*/
	public static AngularSite create(long siteId) {
	...
	*/
	public static AngularSite remove(long siteId)
		throws eu.gerhards.liferay.services.angular.exception.NoSuchAngularSiteException {
		return getPersistence().remove(siteId);
	}

	public static AngularSite updateImpl(AngularSite angularSite) {
		return getPersistence().updateImpl(angularSite);
	}
	...
	* @throws NoSuchAngularSiteException if a Site with the primary key could not be found
	*/
	public static AngularSite findByPrimaryKey(long siteId)
		throws eu.gerhards.liferay.services.angular.exception.NoSuchAngularSiteException {
	...
	*/
	public static AngularSite fetchByPrimaryKey(long siteId) {
		return getPersistence().fetchByPrimaryKey(siteId);
	}

	public static java.util.Map<java.io.Serializable, AngularSite> fetchByPrimaryKeys(
	...
	* @return the Sites
	*/
	public static List<AngularSite> findAll() {
	...
	*/
	public static List<AngularSite> findAll(int start, int end) {
	...
	*/
	...
	public static AngularSitePersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<AngularSitePersistence, AngularSitePersistence> _serviceTracker =
		ServiceTrackerFactory.open(AngularSitePersistence.class);
}