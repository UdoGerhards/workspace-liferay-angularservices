...
/**
 * Provides the local service interface for AngularVirtualInstance. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AngularVirtualInstanceLocalServiceUtil
...
public interface AngularVirtualInstanceLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AngularVirtualInstanceLocalServiceUtil} to access the Virtual instance local service. Add custom service methods to {@link eu.gerhards.liferay.services.angular.service.impl.AngularVirtualInstanceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AngularVirtualInstance addAngularVirtualInstance(
	...
	*/
	public AngularVirtualInstance createAngularVirtualInstance(
	...
	*/
	...
	public AngularVirtualInstance deleteAngularVirtualInstance(
		AngularVirtualInstance angularVirtualInstance);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AngularVirtualInstance deleteAngularVirtualInstance(
		long virtualInstanceId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AngularVirtualInstance fetchAngularVirtualInstance(
		long virtualInstanceId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AngularVirtualInstance getAngularVirtualInstance(
		long virtualInstanceId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AngularVirtualInstance updateAngularVirtualInstance(
		AngularVirtualInstance angularVirtualInstance);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AngularVirtualInstance> getAngularVirtualInstances(int start,
		int end);
