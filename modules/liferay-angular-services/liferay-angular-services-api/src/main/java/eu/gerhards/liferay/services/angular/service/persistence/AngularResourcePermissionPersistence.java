 ...
 * @see AngularResourcePermissionUtil
 * @generated
 */
@ProviderType
public interface AngularResourcePermissionPersistence extends BasePersistence<AngularResourcePermission> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AngularResourcePermissionUtil} to access the Resource permission persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<AngularResourcePermission> angularResourcePermissions);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, AngularResourcePermission> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<AngularResourcePermission> findAll();
	...
	*/
	public java.util.List<AngularResourcePermission> findAll(int start, int end);
	...
	*/
	public java.util.List<AngularResourcePermission> findAll(int start,
		int end,
		com.liferay.portal.kernel.util.OrderByComparator<AngularResourcePermission> orderByComparator);
