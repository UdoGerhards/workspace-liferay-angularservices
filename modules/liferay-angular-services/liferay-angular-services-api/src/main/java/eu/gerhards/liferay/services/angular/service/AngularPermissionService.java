...
/**
 * Provides the remote service interface for AngularPermission. Methods of this
...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=angularservices", "json.web.service.context.path=AngularPermission"}, service = AngularPermissionService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface AngularPermissionService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
