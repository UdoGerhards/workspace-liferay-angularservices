...
/**
 * Provides the local service interface for AngularPermission. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AngularPermissionLocalServiceUtil
...
public interface AngularPermissionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AngularPermissionLocalServiceUtil} to access the Permission local service. Add custom service methods to {@link eu.gerhards.liferay.services.angular.service.impl.AngularPermissionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AngularPermission addAngularPermission(
	...
	*/
	public AngularPermission createAngularPermission(long permissionId);
	...
	*/
	...
	public AngularPermission deleteAngularPermission(
		AngularPermission angularPermission);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AngularPermission deleteAngularPermission(long permissionId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AngularPermission fetchAngularPermission(long permissionId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AngularPermission getAngularPermission(long permissionId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AngularPermission updateAngularPermission(
		AngularPermission angularPermission);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AngularPermission> getAngularPermissions(int start, int end);
