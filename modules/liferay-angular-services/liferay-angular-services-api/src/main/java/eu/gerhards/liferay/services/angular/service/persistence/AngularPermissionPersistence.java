 ...
 * @see AngularPermissionUtil
 * @generated
 */
@ProviderType
public interface AngularPermissionPersistence extends BasePersistence<AngularPermission> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AngularPermissionUtil} to access the Permission persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(
		java.util.List<AngularPermission> angularPermissions);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, AngularPermission> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<AngularPermission> findAll();
	...
	*/
	public java.util.List<AngularPermission> findAll(int start, int end);
	...
	*/
	public java.util.List<AngularPermission> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AngularPermission> orderByComparator);
