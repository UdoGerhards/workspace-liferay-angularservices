...
/**
 * Provides the local service interface for AngularBootstrap. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AngularBootstrapLocalServiceUtil
...
public interface AngularBootstrapLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AngularBootstrapLocalServiceUtil} to access the Bootstrap local service. Add custom service methods to {@link eu.gerhards.liferay.services.angular.service.impl.AngularBootstrapLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public AngularBootstrap addAngularBootstrap(
	...
	*/
	public AngularBootstrap createAngularBootstrap(long bootId);
	...
	*/
	...
	public AngularBootstrap deleteAngularBootstrap(
		AngularBootstrap angularBootstrap);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public AngularBootstrap deleteAngularBootstrap(long bootId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AngularBootstrap fetchAngularBootstrap(long bootId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AngularBootstrap getAngularBootstrap(long bootId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public AngularBootstrap updateAngularBootstrap(
		AngularBootstrap angularBootstrap);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AngularBootstrap> getAngularBootstraps(int start, int end);
