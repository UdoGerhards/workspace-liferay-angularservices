...
public class AngularGroupServiceHttp {
	public static java.util.List<com.liferay.portal.kernel.model.Group> getInstanceGroups(
		...
		try {
			MethodKey methodKey = new MethodKey(AngularGroupServiceUtil.class,
					"getInstanceGroups", _getInstanceGroupsParameterTypes0);
	...
	public static java.util.List<com.liferay.portal.kernel.model.Group> getActiveGroups(
		...
		try {
			MethodKey methodKey = new MethodKey(AngularGroupServiceUtil.class,
					"getActiveGroups", _getActiveGroupsParameterTypes1);
	...
	public static java.util.List<com.liferay.portal.kernel.model.Group> getInactiveGroups(
		...
		try {
			MethodKey methodKey = new MethodKey(AngularGroupServiceUtil.class,
					"getInactiveGroups", _getInactiveGroupsParameterTypes2);
	...
	public static com.liferay.portal.kernel.model.Group createGroup(
		...
		try {
			MethodKey methodKey = new MethodKey(AngularGroupServiceUtil.class,
					"createGroup", _createGroupParameterTypes3);
	...
	public static com.liferay.portal.kernel.model.Group updateGroup(
		...
		try {
			MethodKey methodKey = new MethodKey(AngularGroupServiceUtil.class,
					"updateGroup", _updateGroupParameterTypes4);
	...
	public static long[] checkGroups(HttpPrincipal httpPrincipal, long userId,
		long[] groupIds)
		throws com.liferay.portal.kernel.exception.PortalException {
		try {
			MethodKey methodKey = new MethodKey(AngularGroupServiceUtil.class,
					"checkGroups", _checkGroupsParameterTypes6);
	...
	private static Log _log = LogFactoryUtil.getLog(AngularGroupServiceHttp.class);
	private static final Class<?>[] _getInstanceGroupsParameterTypes0 = new Class[] {
			long.class
		};
	private static final Class<?>[] _getActiveGroupsParameterTypes1 = new Class[] {
			long.class
		};
	private static final Class<?>[] _getInactiveGroupsParameterTypes2 = new Class[] {
			long.class
		};
	private static final Class<?>[] _createGroupParameterTypes3 = new Class[] {
			long.class, long.class, java.util.Map.class, java.util.Map.class,
			int.class, boolean.class, int.class, java.lang.String.class,
			boolean.class, boolean.class, boolean.class
		};
	private static final Class<?>[] _updateGroupParameterTypes4 = new Class[] {
	...
	private static final Class<?>[] _checkGroupsParameterTypes6 = new Class[] {
