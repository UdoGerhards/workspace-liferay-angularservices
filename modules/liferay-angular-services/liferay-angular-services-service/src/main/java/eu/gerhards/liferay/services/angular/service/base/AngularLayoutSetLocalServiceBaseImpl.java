...
import eu.gerhards.liferay.services.angular.service.AngularLayoutSetLocalService;
...
/**
 * Provides the base implementation for the LayoutSet local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link eu.gerhards.liferay.services.angular.service.impl.AngularLayoutSetLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class AngularLayoutSetLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AngularLayoutSetLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link eu.gerhards.liferay.services.angular.service.AngularLayoutSetLocalServiceUtil} to access the LayoutSet local service.
	 */
	...
	public AngularLayoutSet addAngularLayoutSet(
		...
		return angularLayoutSetPersistence.update(angularLayoutSet);
	}
	...
	public AngularLayoutSet createAngularLayoutSet(long layoutSetId) {
		return angularLayoutSetPersistence.create(layoutSetId);
	}
	...
	public AngularLayoutSet deleteAngularLayoutSet(long layoutSetId)
		...
		return angularLayoutSetPersistence.remove(layoutSetId);
	}
	...
	public AngularLayoutSet deleteAngularLayoutSet(
		AngularLayoutSet angularLayoutSet) {
		return angularLayoutSetPersistence.remove(angularLayoutSet);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(AngularLayoutSet.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return angularLayoutSetPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return angularLayoutSetPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public AngularLayoutSet fetchAngularLayoutSet(long layoutSetId) {
		return angularLayoutSetPersistence.fetchByPrimaryKey(layoutSetId);
	}
	...
	public AngularLayoutSet getAngularLayoutSet(long layoutSetId)
		throws PortalException {
		return angularLayoutSetPersistence.findByPrimaryKey(layoutSetId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(angularLayoutSetLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(AngularLayoutSet.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(angularLayoutSetLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(AngularLayoutSet.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return angularLayoutSetLocalService.deleteAngularLayoutSet((AngularLayoutSet)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return angularLayoutSetPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<AngularLayoutSet> getAngularLayoutSets(int start, int end) {
		return angularLayoutSetPersistence.findAll(start, end);
	}
	...
	public int getAngularLayoutSetsCount() {
		return angularLayoutSetPersistence.countAll();
	}
	 ...
	 */
	public AngularLayoutSetLocalService getAngularLayoutSetLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("eu.gerhards.liferay.services.angular.model.AngularLayoutSet",
			angularLayoutSetLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"eu.gerhards.liferay.services.angular.model.AngularLayoutSet");
	}
	...
	public String getOSGiServiceIdentifier() {
		return AngularLayoutSetLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = angularLayoutSetPersistence.getDataSource();
	...
	@BeanReference(type = AngularLayoutSetLocalService.class)
	protected AngularLayoutSetLocalService angularLayoutSetLocalService;
